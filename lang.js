...
(function () {
    ...
    var translations = {
        ...
        "hero-btn-find": { en: "Find Us", es: "Encu\u00e9ntranos" },
        ...
        "contact-find-title": { en: "Find Us", es: "Encu\u00e9ntranos" },
    ...
    /* ---------- update the toggle highlight ---------- */
    function updateToggleButtons(lang) {
        var allOpts = document.querySelectorAll(".lang-opt");
        for (var i = 0; i < allOpts.length; i++) {
            if (allOpts[i].getAttribute("data-lang") === lang) {
                allOpts[i].classList.add("lang-active");
            } else {
                allOpts[i].classList.remove("lang-active");
            }
        }
    }
